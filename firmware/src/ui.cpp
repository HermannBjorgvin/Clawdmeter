...
struct Layout {
    ...
    bool    usage_panels_row;   // true = side by side (landscape strips), false = stacked
...
static void compute_layout(const BoardCaps& c) {
    ...
    L.pair_y3 = 160;
    L.idle_px = 160;
    L.usage_panels_row = false;   // stacked; the landscape branch below flips this
...
static void init_usage_screen(lv_obj_t* scr) {
    ...
    panel_session = make_usage_panel(usage_group, L.margin, L.content_y, L.usage_panel_w,
                     "Current",
    ...
    // Second panel goes to the right of the first on landscape strips too
    // short to stack them, below it everywhere else.
    ...
    panel_weekly = make_usage_panel(usage_group, weekly_x, weekly_y, L.usage_panel_w,
                     "Weekly",
